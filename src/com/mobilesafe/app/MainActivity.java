...
public class MainActivity extends Activity {
	...
	private static String[] bgColors = {
		"#65b3cb", "#b3d030", "#8000ff", 
		"#ffaec9", "#42bbb4", "#f99877", 
		"#e9b438", "#b500b5", "#177ab1"
	};
...
//					showLoastFindDialog();
	...
	private void showEnterDialog() {
		...
		View view = View.inflate(MainActivity.this, R.layout.dialog_enter_pwd, null);
	...
	private void showSetupPwdDialog() {
		AlertDialog.Builder builder = new Builder(MainActivity.this);
		View view = View.inflate(MainActivity.this, R.layout.dialog_setup_pwd, null);
		builder.setView(view);
		...
		bt_ok.setOnClickListener(new Button.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (pwd.equals(confirm_pwd)) {
					Editor edit = sp.edit();
					edit.putString("password", CommonUtil.md5EncodePassword(pwd));
					edit.commit();
					mDialog.dismiss();
					enterIndexPage(MobileSafeActivity.class);
	...
	class MyAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			ViewHolder holder;
			if (convertView == null) {
				view = View.inflate(MainActivity.this, R.layout.list_item_main, null);
