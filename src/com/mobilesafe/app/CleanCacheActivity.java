 ...
 * 
 */
public class CleanCacheActivity extends BaseAcitivity implements OnClickListener {

    private LinearLayout ll_container;
    private ListView listView;
    private List<Map<String, String>> cacheInfo = new ArrayList<Map<String,String>>();
    private List<Drawable> appLogos = new ArrayList<Drawable>();
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (cache > 0) {
                            ...
                            map.put("size", Formatter.formatFileSize(getApplicationContext(), cache));
    ...
    private void showFinishCleanCache() {
        ...
        View view = View.inflate(getApplicationContext(), R.layout.finish_clean_cache, null);
        bt_finish_cleanCaches = (Button) view.findViewById(R.id.bt_finish_clean_cache);
